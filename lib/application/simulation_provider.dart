...
final solveReportProvider = Provider<SolveReport>((ref) {
...
final gateCountProvider = Provider<int>((ref) {
  return ref.watch(circuitControllerProvider).gateCount;
});

/// Stars the current board would earn, or 0 while it is unsolved.
final earnedStarsProvider = Provider<int>((ref) {
  final level = ref.watch(levelProvider);
...
final hintRevealedProvider =
    NotifierProvider<HintController, bool>(HintController.new);
